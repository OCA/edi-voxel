This module extends the functionality of 'Voxel stock picking' module to
...
- If 'secondary unit of measure' is set, this will be the unit of
  measure to be sent.
- If 'secondary unit of measure' is not set, standard quantity and
  standard unit of measure will be send.
